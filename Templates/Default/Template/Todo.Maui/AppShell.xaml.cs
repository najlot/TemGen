...
public partial class AppShell : ContentPage, INavigationService, INotificationService
{
	private readonly ViewStackNavigator<View> _viewNavigator;
	...
	public AppShell()
	{
		...
		_viewNavigator = new ViewStackNavigator<View>(serviceProvider);
	...
	public bool CanNavigateBack() => _viewNavigator.CanNavigateBack();

	public async Task NavigateBack()
	{
		await ClearNotificationsAsync();
		await _viewNavigator.NavigateBack();
		ContentHost.Content = _viewNavigator.CurrentView;
	}
	...
	{
		await ClearNotificationsAsync();
		await _viewNavigator.NavigateForward<TViewModel>(parameters);
		ContentHost.Content = _viewNavigator.CurrentView;
	}
