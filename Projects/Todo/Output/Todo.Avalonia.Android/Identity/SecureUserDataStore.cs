...
namespace Todo.Avalonia.Android.Identity;
...
public class SecureUserDataStore : IUserDataStore
{
	...
	private const string PreferencesName = "Todo.identity.secure";
	private const string StorageKey = "user_data";
	private const int TagLengthBits = 128;
	private static readonly string KeyAlias = "Todo.identity.key";
